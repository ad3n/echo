...
func TestHandlerName(t *testing.T) {
	...
	var testCases = []struct {
	...
	}{
		{
			...
			expect: "github.com/ad3n/echo/v5.TestHandlerName.func2",
		},
		{
			name:            "ok, func as named package variable",
			whenHandlerFunc: myNamedHandler,
			expect:          "github.com/ad3n/echo/v5.init.func4",
		},
		{
			name:            "ok, func as named function variable",
			whenHandlerFunc: myNameFuncVar,
			expect:          "github.com/ad3n/echo/v5.TestHandlerName.func1",
		},
		{
			name:            "ok, func as struct method",
			whenHandlerFunc: tmp.getUsers,
			expect:          "github.com/ad3n/echo/v5.(*NameStruct).getUsers-fm",
		},
	}
